...
**岗位收录助手**(浏览器插件,可选):装到 Chrome/Edge 后在任意岗位详情页点图标,自动识别公司/岗位/城市一键收录进控制台「手动收录」岗位源——识别在本页完成,结果只发到本机 127.0.0.1:7788,不经任何服务器。源码在 [plugin/](plugin/),下载 zip 见 Releases(解压后 chrome://extensions 开发者模式加载)。
