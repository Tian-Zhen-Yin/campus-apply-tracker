...
**岗位收录助手**(浏览器插件,可选):装到 Chrome/Edge 后在任意岗位详情页点图标,自动识别公司/岗位/城市——确认收录时**默认同时记为已投递**(岗位库条目+投递总览记录一次完成;只是先收藏还没投,取消勾选即可)。识别在本页完成,结果只发到本机 127.0.0.1:7788,不经任何服务器。源码在 [plugin/](plugin/),下载 zip 见 Releases(解压后 chrome://extensions 开发者模式加载)。
